...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250724155158_ReplaceArraysToListInCardTariffs")]
    partial class ReplaceArraysToListInCardTariffs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Banks.CardTariffsEntity", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("Curency")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.PrimitiveCollection<string>("EnabledPaymentSystem")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
